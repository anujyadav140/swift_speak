...
class GlobalInputListenerService : AccessibilityService() {
    ...
    override fun onAccessibilityEvent(event: AccessibilityEvent?) {
        ...
        if (event.eventType == AccessibilityEvent.TYPE_VIEW_FOCUSED || 
            ...
            if (isInputActive != lastInputState) {
                ...
                // Send broadcast
                val intent = Intent("com.anujsyadav.swiftspeak.INPUT_STATE")
    ...
    private val textInjectionReceiver = object : BroadcastReceiver() {
        override fun onReceive(context: Context?, intent: Intent?) {
            if (intent?.action == "com.anujsyadav.swiftspeak.INSERT_TEXT") {
    ...
    override fun onServiceConnected() {
        ...
        val filter = IntentFilter("com.anujsyadav.swiftspeak.INSERT_TEXT")
