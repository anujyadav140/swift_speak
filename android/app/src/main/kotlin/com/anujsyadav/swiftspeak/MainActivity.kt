...
class MainActivity : FlutterActivity() {
    private val CHANNEL = "com.anujsyadav.swiftspeak/input_state"
    ...
    private val receiver = object : BroadcastReceiver() {
        override fun onReceive(context: Context?, intent: Intent?) {
            if (intent?.action == "com.anujsyadav.swiftspeak.INPUT_STATE") {
    ...
    override fun configureFlutterEngine(flutterEngine: FlutterEngine) {
        ...
        EventChannel(flutterEngine.dartExecutor.binaryMessenger, CHANNEL).setStreamHandler(
            object : EventChannel.StreamHandler {
                override fun onListen(arguments: Any?, events: EventChannel.EventSink?) {
                    eventSink = events
                    val filter = IntentFilter("com.anujsyadav.swiftspeak.INPUT_STATE")
        ...
        MethodChannel(flutterEngine.dartExecutor.binaryMessenger, "com.anujsyadav.swiftspeak/settings").setMethodCallHandler { call, result ->
        ...
        MethodChannel(flutterEngine.dartExecutor.binaryMessenger, "com.anujsyadav.swiftspeak/app").setMethodCallHandler { call, result ->
        ...
        screenshotChannel = MethodChannel(flutterEngine.dartExecutor.binaryMessenger, "com.anujsyadav.swiftspeak/screenshot")
